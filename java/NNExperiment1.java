...
public class NNExperiment1 extends Experiment {
  ...
  private double[][][] train(List<double[]> x, List<Double> y, int layers, int layerNodes, int epochs, double g0) {
  ...
  private void printWeights(double[][][] w) {
    ...
    for (double[][] l : w) {
      ...
      for (double[] n : l) {
        System.out.print("[");
        for (double j : n)
          System.out.print(" " + this.df.format(j) + " ");
        System.out.println("]");
      }
      System.out.println("]");
    }
